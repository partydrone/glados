...
ActiveRecord::Schema.define(version: 20170413205422) do
  ...
  create_table "downloads", force: :cascade do |t|
    ...
    t.index ["download_type_id"], name: "index_downloads_on_download_type_id"
  end
  ...
  create_table "enrollments", force: :cascade do |t|
    ...
    t.string "last_name"
    t.string "email"
    t.index ["training_event_course_id"], name: "index_enrollments_on_training_event_course_id"
  end
  ...
  create_table "feature_associations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["feature_id"], name: "index_feature_associations_on_feature_id"
    t.index ["product_id"], name: "index_feature_associations_on_product_id"
  end
  ...
  create_table "patents", force: :cascade do |t|
    t.integer "number"
    t.string "title"
    t.index ["number"], name: "index_patents_on_number", unique: true
  end
  ...
  create_table "training_course_products", force: :cascade do |t|
    ...
    t.integer "product_id"
    t.integer "position"
    t.index ["product_id"], name: "index_training_course_products_on_product_id"
    t.index ["training_course_id"], name: "index_training_course_products_on_training_course_id"
  end
  ...
  create_table "training_courses", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "summary"
    t.index ["training_course_type_id"], name: "index_training_courses_on_training_course_type_id"
  end
  ...
  create_table "training_event_courses", force: :cascade do |t|
    ...
    t.string "room"
    t.datetime "ended_at"
    t.index ["training_course_id"], name: "index_training_event_courses_on_training_course_id"
    t.index ["training_event_id"], name: "index_training_event_courses_on_training_event_id"
  end
